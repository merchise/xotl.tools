...
from xoutil.collections import ChainMap, Counter
from xoutil.collections import OrderedDict, RankedDict
...
class TestRankedDict(unittest.TestCase):
    def test_init(self):
        ...
        # mixed input
        self.assertNotEqual(list(RankedDict([('a', 1), ('b', 2), ('c', 9),
                                             ('d', 4)], c=3, e=5).items()),
                            pairs)
    ...
    def test_setitem(self):
        ...
        od['c'] = 10           # existing element
        od['f'] = 20           # new element
        self.assertEqual(list(od.items()), [('d', 1), ('b', 2), ('a', 4),
                                            ('e', 5), ('c', 10), ('f', 20)])
