...
** Release version 1.8 <2017-10-21 sáb> [3/7]
...
- [ ] Manage deprecation warnings (code and documentation) for: [0/1]

  - [ ] 'xoutil.future.string' must be fully deprecated. [0/3]

    See [[file:xoutil/future/string.py][module]].

    - [ ] There are some useful tools in there that must be migrated to
      [[file:xoutil/future/textwrap.py][xoutil.future.textwrap]], [[file:xoutil/eight/__init__.py][xoutil.eight]], and a new one
      [[file:xoutil/future/codecs.py][xoutil.future.codecs]].

      - [ ] xoutil.future.codecs [0/3]
