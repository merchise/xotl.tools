...
** Release version 1.8 <2017-10-21 sáb> [5/20]
...
- [-] Manage deprecation warnings (code and documentation) for: [0/1]
  ...
  - [-] 'xoutil.future.string' must be fully deprecated. [0/1]

    See [[file:xoutil/future/string.py][module]].

    - [-] Some useful tools in there that must be migrated [12/13]
      ...
      - [X] Following functions are deleted from [[file:xoutil/future/string.py][future.string]] [4/4]
