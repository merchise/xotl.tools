...
- [ ] '[[file:xoutil/future/threading.py][future.threading]]' module has two errors in the documentation of
  'stack_size' function.  Fix [[file:docs/source/xoutil/future][documentation]] of all 'future' in order not
  to use 'automodule'.
